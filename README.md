...
- [`docs/DEPLOY_GCP.md`](docs/DEPLOY_GCP.md) — GCP VM deploy, HTTPS (Caddy), and `production` CI/CD  
- [`docs/gcp-https-and-cicd-plan.md`](docs/gcp-https-and-cicd-plan.md) — human/agent checklists for HTTPS and pipelines  
