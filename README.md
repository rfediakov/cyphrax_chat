...
- [`docs/DEPLOY_GCP.md`](docs/DEPLOY_GCP.md) — GCP VM deployment and production CI/CD
- [`docs/gcp-https-and-cicd-plan.md`](docs/gcp-https-and-cicd-plan.md) — human/agent checklist for HTTPS and pipelines
